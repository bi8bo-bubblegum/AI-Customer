...
from app.schemas.work_order import UpdateWorkOrderRequest, WorkOrderResponse
...
async def get_work_orders(
    ...
    return success(data=[WorkOrderResponse.model_validate(o).model_dump() for o in orders])
...
async def get_work_order(
    ...
    return success(data=WorkOrderResponse.model_validate(order).model_dump())
